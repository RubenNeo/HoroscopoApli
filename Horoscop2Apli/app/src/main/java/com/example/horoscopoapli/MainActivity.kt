...
class MainActivity : AppCompatActivity() {
    ...
    val horoscopeList: List<Horoscope> = listOf(
        ...
        Horoscope("Tauro", R.string.horoscope_name_taurus, R.string.horoscope_date_aries, R.drawable.tauro),
        Horoscope("Gemini", R.string.horoscope_name_gemini, R.string.horoscope_date_gemini, R.drawable.geminis),
        ...
        Horoscope("Sagittarius", R.string.horoscope_name_sagittarius, R.string.horoscope_date_sagittarius, R.drawable.sagitario),
        Horoscope("Capricorn", R.string.horoscope_name_capricorn, R.string.horoscope_date_capricorn, R.drawable.capricornio),
        Horoscope("Aquarius", R.string.horoscope_name_aquarius, R.string.horoscope_date_aquarius, R.drawable.aquarius),
        Horoscope("Piscis", R.string.horoscope_name_pisces, R.string.horoscope_date_pisces, R.drawable.piscis)
    )
